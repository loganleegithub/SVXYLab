...
def main() -> int:
    parser = argparse.ArgumentParser(description="SVXYLab 本地研究程序（P0 环境至 P6 诊断）")
    parser.add_argument("command", choices=["environment", "data", "baselines", "features", "predictions", "economics", "diagnostics"], help="生成当前阶段的本地研究报告")
