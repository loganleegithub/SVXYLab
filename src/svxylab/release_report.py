...
<p>P7工程修正记录：兼容P4旧验收记录的报告路径；将休市的请求边界映射到2024-01-02实际收盘；额外延迟首日保留2023-12-29已验收预测（信息日2023-12-28）；拆开变体函数返回的预测表与JSON摘要。原失败日志、冻结版本和计算产物均保留，未改模型/目标。<a href='../runs/p7/execution_boundary_fix.json'>执行边界修正</a> · <a href='../runs/p7/initialization_counterexample.json'>真实首日反例与影响日期</a> · <a href='../runs/p7/summary_serialization_fix.json'>汇总封装修正</a>。</p>
